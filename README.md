...
| "Clean connect flow — Freighter connected first try. The live RPC latency + verified wallet stream is a nice trust touch. Suggestion: let new users browse the User Guide before connecting, easier onboarding for testers. Solid architecture! — Ubong (Nova Esusu)" | Added pre-connect access to the integrated User Guide and onboarding flow so new users can review wallet connection, Testnet tools, transfers, Soroban interactions, and transaction verification before connecting Freighter. ([commit `22cb358`](https://github.com/mustafaColak0/stellar-shield-wallet-v3/commit/22cb3584f0ec608429ba264db099436574e1b9e9) · [@ubongn](https://github.com/ubongn)) | **Completed** |
